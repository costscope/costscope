...
- Local runs
  ...
  - `SYFT_VERSION=v1.27.1 bash scripts/release/install-syft.sh` # adjust as needed; prefer latest compatible release
...
- Version pinning (Variant B)
  ...
  - In Release/Supply-chain: `SYFT_VERSION: v1.27.1`, `COSIGN_VERSION: v2.2.4`

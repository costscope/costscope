...
- The per-package minimum in `coverage.min github.com/costscope/costscope/internal/core/production=92`.
...
- `coverage.min github.com/costscope/costscope/internal/core/production=92`
